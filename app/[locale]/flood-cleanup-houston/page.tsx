...
export default async function FloodCleanupHoustonPage({ params }: Props) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: isEs ? "Limpieza de Inundaciones" : "Flood Cleanup", item: "https://houstonhomerestore.com/flood-cleanup-houston" },
    ],
  };
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      {/* Hero */}
      <Image
        src="/images/flood-cleanup-hero.jpg"
        alt={isEs ? "Limpieza de inundación en una calle de Houston" : "Flood cleanup on a Houston street"}
        width={1280}
        height={720}
      ...
      <Breadcrumbs
        items={[
          { label: isEs ? "Limpieza de Inundaciones" : "Flood Cleanup" },
        ]}
        locale={locale}
      />
